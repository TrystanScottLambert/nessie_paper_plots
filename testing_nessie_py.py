"""
Making sure that we can use nessie_py in the same way we can use nessie. 
"""
...
random_zs = np.loadtxt("/Users/00115372/Desktop/GAMA_paper_plotter/gama_g09_randoms.txt",skiprows=1)
